...
const PageHeader = lazy(() => import('@tminds/components/utility/pageHeader'));
const Box = lazy(() => import('@tminds/components/utility/box'));
const LayoutWrapper = lazy(() =>
  import('@tminds/components/utility/layoutWrapper')
);
const ContentHolder = lazy(() =>
  import('@tminds/components/utility/contentHolder')
);
