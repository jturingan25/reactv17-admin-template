...
import PageHeader from '@tminds/components/utility/pageHeader';
import Box from '@tminds/components/utility/box';
import LayoutWrapper from '@tminds/components/utility/layoutWrapper';
import ContentHolder from '@tminds/components/utility/contentHolder';
import basicStyle from '@tminds/assets/styles/constants';
